...
<div class="sidebar" id="sidebar">
    ...
    <ul class="nav flex-column">
            ...
            <ul class="nav flex-column ps-3">
                <li class="nav-item">
                    <a href="doc_importdata.php" class="nav-link <?php echo ($currentPage === 'doc_importdata.php') ? 'active' : ''; ?>">
                        <i class="fas fa-cloud-upload-alt"></i><span> Import Data</span>
                    </a>
                </li>
                <li class="nav-item">
        ...
        <!--<li class="nav-item">
            <a href="doc_reports.php" class="nav-link <?php echo ($currentPage === 'doc_reports.php') ? 'active' : ''; ?>">
                <i class="fas fa-clipboard-list"></i><span> Reports</span>
            </a>
        </li>-->
        <li class="nav-item">
