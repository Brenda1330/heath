...
CREATE TABLE `recommendations` (
  ...
  CONSTRAINT `recommendations_ibfk_1` FOREIGN KEY (`patient_id`) REFERENCES `patients` (`patient_id`),
  CONSTRAINT `recommendations_ibfk_2` FOREIGN KEY (`insight_id`) REFERENCES `graph_insights` (`insight_id`)
