...
<div class="main-content">
  ...
  <div class="row g-4 mb-5">
    <div class="col-md-4"><div class="card text-center p-4 shadow-sm" style="border-radius: 16px;"><h6 class="text-muted mb-2">Doctors</h6><h2 class="count" data-target="<?php echo htmlspecialchars($doctor_count); ?>">0</h2></div></div>
    <div class="col-md-4"><div class="card text-center p-4 shadow-sm" style="border-radius: 16px;"><h6 class="text-muted mb-2">Patients</h6><h2 class="count" data-target="<?php echo htmlspecialchars($patient_count); ?>">0</h2></div></div>
    <div class="col-md-4"><div class="card text-center p-4 shadow-sm" style="border-radius: 16px;"><h6 class="text-muted mb-2">Completed Audits</h6><h2 class="count" data-target="<?php echo htmlspecialchars($audit_count); ?>">0</h2></div></div>
  </div>
