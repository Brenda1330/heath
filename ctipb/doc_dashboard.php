...
</div> <!-- Close dashboard-header div -->

<!-- Patient Summary Section -->
<div class="pro-search-sort-container">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1>Patient Summary</h1>
        <div class="d-flex align-items-center gap-3">
            <input type="text" id="searchInput" placeholder="Search patients or status..." class="form-control pro-search-input">
            ...
            <div class="dropdown">
                <button class="btn btn-light dropdown-toggle pro-sorting-btn" type="button" id="sortMenu" data-bs-toggle="dropdown" aria-expanded="false">
                    Sort by: Default
                    <span id="sortIndicator" class="sort-indicator ms-1"></span>
                </button>
...
<div class="pro-table-container">
    <div class="pro-table-responsive">
        <table id="patientTable" class="pro-data-table">
            <thead>
                <tr>
                    <th>Patient Name</th>
                    <th>CGM Level (mmol/L)</th>
                    <th>Status</th>
                    <th>Last Updated</th>
                </tr>
            </thead>
            <tbody>
                ...
                <?php else: ?>
                    <tr>
                        <td colspan="4" class="pro-table-empty-state">
                            <i class="fas fa-users"></i>
                            <p>No patient data available</p>
                            <small>Patients will appear here once added to your care</small>
                        </td>
                    </tr>
                <?php endif; ?>
            </tbody>
