...
<div class="main-content">
    ...
    <div class="card recommendation-card" data-aos="fade-up">
        ...
        <div id="similarPatientsSection" class="mt-4" style="display: none;">
                <h5 class="step-title mt-5">Similar Patient Cohort</h5>
                <p class="step-description">The following patients from the database were found to have similar glucose levels, providing context for the recommendation.</p>
                    ...
                    <table class="table table-sm table-bordered table-striped table-hover">
                        <thead class="table-light">
                            <tr>
                                <th>Patient Name</th>
                                <th>Age</th>
                                <th>Relevant CGM (mmol/L)</th>
                                <th>Recent Diet</th>
                                <th>Recent Activity</th>
                            </tr>
                        </thead>
                        <tbody id="similarPatientsTableBody">
